...
entryRuleInline returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInlineRule()); }
	iv_ruleInline=ruleInline
	{ $current=$iv_ruleInline.current; }
	EOF;

// Rule Inline
ruleInline returns [EObject current=null]
@init {
	enterRule();
}
@after {
