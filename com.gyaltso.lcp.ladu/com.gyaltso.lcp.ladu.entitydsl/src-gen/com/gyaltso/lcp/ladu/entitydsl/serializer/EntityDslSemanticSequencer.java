 ...
 *******************************************************************************/
package com.gyaltso.lcp.ladu.entitydsl.serializer;
...
public class EntityDslSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == EntityDslPackage.eINSTANCE)
			...
			case EntityDslPackage.INLINE:
				sequence_Inline(context, (Inline) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (name=QualifiedName importSection=XImportSection? models+=Model*)
	 */
	...
	/**
	 * Contexts:
	 *     Inline returns Inline
	 *
	 * Constraint:
	 *     (properties+=[Property|ID] properties+=[Property|ID]*)
	 */
	protected void sequence_Inline(ISerializationContext context, Inline semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Literal(ISerializationContext context, Literal semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EntityDslPackage.Literals.LITERAL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EntityDslPackage.Literals.LITERAL__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getLiteralAccess().getNameValidIDParserRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (annotations+=XAnnotation* name=ValidID array?='*'? type=JvmParameterizedTypeReference)
	 */
